...
public class DemoActivity extends Activity implements OnClickListener, RadioGroup.OnCheckedChangeListener {
    ...
    private CheckBox rtcCalleeMode, frontCameraMirror, cKtestSWInterface, ckManual_focus, show_debug_info;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rtcCalleeMode = (CheckBox) findViewById(R.id.rtc_callee_mode);
            ...
            case R.id.connectBT:
                ...
                if (!TextUtils.isEmpty(urlET.getText())
                    ...
                    CameraActivity.startActivity(getApplicationContext(), 0, urlET.getText().toString(),
                            frameRate, videoBitRate, audioBitRate, videoResolution, encodeWithHEVC, landscape,
                            isFrontCameraMirror, encode_method, startAuto, testSWInterface, manual_focus, debug_info,
                            isRTCCallee);
